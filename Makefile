...
AVRDUDE_FLAGS = -p $(MCU) -c $(AVRDUDE_PROGRAMMER) -B 4
AVRDUDE_FLAGS += $(AVRDUDE_NO_VERIFY)
AVRDUDE_FLAGS += $(AVRDUDE_VERBOSE)
AVRDUDE_FLAGS += $(AVRDUDE_ERASE_COUNTER)

#AVRDUDE_WRITE_LFUSE = -U lfuse:w:0xc1:m # 64MHz
AVRDUDE_WRITE_LFUSE = -U lfuse:w:0xe2:m
AVRDUDE_WRITE_HFUSE = -U hfuse:w:0xdf:m
#AVRDUDE_WRITE_EFUSE = -U efuse:w:0xf9:m
...
program: $(TARGET).hex $(TARGET).eep
	...
	$(AVRDUDE_WRITE_HFUSE) $(AVRDUDE_WRITE_LFUSE) $(AVRDUDE_WRITE_EFUSE) \
	$(AVRDUDE_WRITE_LOCK)
